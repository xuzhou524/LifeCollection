...
-(void)sebViews{
    ...
    _bgView.backgroundColor = [LCColor LCColor_235_235_235];
    ...
    _titleLabel.textColor = [LCColor backgroudColor];
    ...
    classbgView.backgroundColor = [LCColor backgroudColor];
    ...
    remindbgView.backgroundColor = [LCColor backgroudColor];
    ...
    _timeStrLabel.textColor = [LCColor backgroudColor];
    ...
    _timeLabel.textColor = [LCColor backgroudColor];
    ...
    _dayLabel.alpha = 0.8;
    _dayLabel.textColor = [LCColor backgroudColor];
    [self.contentView addSubview:_dayLabel];
    [_dayLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(self.bgView).offset(-20);
        make.centerY.equalTo(self.bgView).offset(20);
    }];
    ...
    _dayStrLabel.textColor = [LCColor backgroudColor];
